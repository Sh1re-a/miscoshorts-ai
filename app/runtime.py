...
from app.paths import DOCTOR_REPORT_PATH, ENV_FILE, INTERNAL_DIR, LOGS_DIR, MODEL_CACHE_DIR, OUTPUT_CACHE_DIR, OUTPUTS_DIR, OUTPUT_TEMP_DIR, RUNTIME_DIR, SETUP_DIR
...
def ensure_runtime_dirs() -> None:
    for directory in (INTERNAL_DIR, RUNTIME_DIR, LOGS_DIR, SETUP_DIR, OUTPUTS_DIR, OUTPUT_CACHE_DIR, OUTPUT_TEMP_DIR, MODEL_CACHE_DIR):
